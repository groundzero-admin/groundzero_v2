/**
 * LiveClassPage — Admin live class with smart video layout.
 *
 * Layout:
 ...
 *  Pinning:          Click any tile to spotlight it; admin can mute remote peers
 */
                ...
                <div style={{ display: "flex", gap: 3, alignItems: "center", flexShrink: 0 }}>
                    ...
                    {onMute && (
                        <button
                            ...
                            style={{ background: "rgba(255,255,255,0.15)", border: "none", borderRadius: 4, padding: "1px 5px", color: "#fff", cursor: "pointer", fontSize: 9 }}
                        >
                            🔇
                        </button>
                    )}
        ...
        <div style={{ display: "flex", flexDirection: "column", height: "100vh", background: "#0b0b1a", color: "#fff", fontFamily: "'Inter',sans-serif" }}>
            ...
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "6px 14px", background: "#101020", borderBottom: "1px solid #1c1c30", flexShrink: 0 }}>
                <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                    <span style={{ fontWeight: 700, fontSize: 14 }}>🎥 Live Class (Admin)</span>
            ...
            <div style={{ display: "flex", flex: 1, overflow: "hidden" }}>
                ...
                {/* ── CHAT SIDEBAR ── */}
                {showChat && (
                    <div style={{ width: 260, flexShrink: 0, display: "flex", flexDirection: "column", background: "#0e0e1e", borderLeft: "1px solid #1c1c30" }}>
